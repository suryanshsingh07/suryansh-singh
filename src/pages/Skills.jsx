...
import framer_motion from '../assets/skill/framer_motion.png';
...
import vite from '../assets/skill/vite.png';
                ...
                data-aos='fade-up'>
                    {skills.map((skill,index) => (
                        ...
                        data-aos-delay={`${300 + index * 100}`}>
                            <div style={{background: darkMode ? 'linear-gradient(to bottom right, #1f2937, #111827)' : 'linear-gradient(to bottom right, #f1f2f3, #f3f4f6)', borderColor: darkMode ? '#374151' : '#e5e7eb' }}
                            className='h-full p-6 rounded-2xl border hover:border-orange-500/50 transition-all duration-300 hover:-translate-y-2 group hover:shadow-[0_0_30px_rgba(255,165,0,0.15)] cursor-pointer'>
                                <div className='flex items-center mb-6'>
                                    <div style={{background: darkMode ? 'linear-gradient(to bottom right, #374152, #1f2937)' : 'linear-gradient(to bottom right, #f3f4f6, #e5e7eb)'}}
