            ...
            <div className='grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 md:gap-10 items-center'>
                ...
                data-aos='fade-left'>
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 mb-3 sm:mb-4'>
                        ...
                        style={{background: darkMode ? '#374151' : '#faede3', borderColor: darkMode ? '#4b5563' : '#d1d5db', color: darkMode ? 'white' : '#1f2937'}}
                        className='w-full px-3 sm:col-span-2 py-2 sm:px-4 sm:py-3 rounded-lg text-sm sm:text-base focus:border-orange-500 focus:ring-2 focus:ring-orange-500/20 transition-all resize-none' required/>
                        <button type='submit'
